...
public class EzVarChart1D extends EzVar<double[]>
{
     ...
     */
    public EzVarChart1D(String varName, double[][] defaultValues, boolean allowUserInput) throws NullPointerException
    {
     ...
     *             if the defaultValues parameter is null
     */
    public EzVarChart1D(String varName, double[][] defaultValues, int defaultValueIndex, boolean allowUserInput) throws NullPointerException
    {
